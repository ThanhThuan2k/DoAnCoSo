...
namespace DoAnCoSo.Data.Migrations
{
    ...
    [Migration("20210429023511_update-foreignKey")]
            ...
            modelBuilder.Entity("DoAnCoSo.DTOs.ChiTietSanPham", b =>
                {
                    ...
                    b.Property<int?>("ThuocDanhMucId")
                        .HasColumnType("int");

                    b.Property<int?>("ThuocHangSanXuatId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ThuocDanhMucId");

                    b.HasIndex("ThuocHangSanXuatId");
            ...
            modelBuilder.Entity("DoAnCoSo.DTOs.ChiTietSanPham", b =>
                {
                    b.HasOne("DoAnCoSo.DTOs.DanhMuc", "ThuocDanhMuc")
                        .WithMany()
                        .HasForeignKey("ThuocDanhMucId");

                    b.HasOne("DoAnCoSo.DTOs.HangSanXuat", "ThuocHangSanXuat")
                        .WithMany()
                        .HasForeignKey("ThuocHangSanXuatId");
