(function() {
    ...
    switch (Bizweb.template) {
        case "collection":
            l = location.pathname !== "/collections/all" ? "collection_view" : "page_view";
            break;
        case "product":
            k = !0;
            d = location.pathname;
            l = "product_view";
            document.referrer !== "" && new URL(document.referrer).pathname === "/search" && (l = "product_view_from_search");
            break;
        case "cart":
            l = "cart_view";
            break;
    ...
    g.prototype.handleXhrDone = function(l) {
        try {
            switch (l.url) {
                case "/cart/add.js":
                    l.xhr.responseText && (n.postData(b, {
                        ...
                        landing_page: r,
                        landing_full_page: t
                    }, a, u), new URL(location.href).pathname === "/search" && n.postData(v, {
                        store_id: f,
                        session_id: s,
                        visitor_id: h,
                        variant_id: n.getParamValue("variantId", l.body),
                    ...
                    break;
                case "/cart/change.js":
                    n.getParamValue("quantity", l.body) === "0" && n.postData(v, {
                        store_id: f,
                        session_id: s,
                        visitor_id: h,
                        variant_id: n.getParamValue("variantId", l.body),
    ...
    XMLHttpRequest.prototype.send = function(n) {
        ...
        return this.addEventListener ? this.addEventListener("readystatechange", t.onReadyStateChange.bind(t), !1) : (t.oldOnReadyStateChange = this.onreadystatechange, this.onreadystatechange = t.onReadyStateChange), et.call(this, n)
    };
    nt = window.fetch;
    "function" == typeof nt && (window.fetch = function() {
        return nt.apply(window, Array.prototype.slice.call(arguments)).then(function(l) {
            if (!l.ok) return l;
            try {
                switch (data.url) {
                    case "/cart/add.js":
                        ...
                        new URL(location.href).pathname === "/search" && n.postData(v, {
                            store_id: f,
                            session_id: s,
                            visitor_id: h,
                            variant_id: n.getParamValue("variantId", data.body),
                        ...
                        break;
                    case "/cart/change.js":
                        n.getParamValue("quantity", query) === "0" && n.postData(v, {
                            store_id: f,
                            session_id: s,
                            visitor_id: h,
                            variant_id: n.getParamValue("variantId", data.body),
